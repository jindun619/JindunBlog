    ...
    return (
        <footer className="footer footer-center p-4">
          <aside className="items-center grid-flow-col">
            <p>© 2023 <a className="link link-primary link-hover" href="https://github.com/jindun619">Hoojun</a>, built with</p>
            <a href="https://www.gatsbyjs.com/">
              <svg className="_1nrsgum" width="91" height="24" fill="#663399" viewBox="0 0 106 28">
                <g>
